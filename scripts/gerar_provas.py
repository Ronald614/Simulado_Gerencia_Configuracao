                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "No modelo centralizado, a indisponibilidade do servidor impede qualquer gravacao de historico pela equipe; no Git distribuido, cada cliente possui um repositorio completo e opera de forma autônoma offline (Slides 5 a 8 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "Essa triade constitui o fluxo operacional central do Git, dividindo o ciclo de vida entre edicao local, preparacao de commits e persistencia definitiva no banco de dados do Git (Slide 22 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": False,
                        "justificativa": "O comando git commit opera estritamente no repositorio local. O envio dos commits locais para o servidor remoto exige o comando de rede git push (Slides 21 e 96 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": True,
                        "justificativa": "O .gitignore define padroes ignorados pelo versionador e deve ser integrado ao repositorio para que toda a equipe adote as mesmas exclusoes de dependencias e credenciais (Slides 30 a 35 de 1_git.pdf e Slide 37 de smartnotes.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": False,
                        "justificativa": "O .gitignore atua somente sobre arquivos nao rastreados (untracked). Arquivos ja comitados permanecem no historico e precisam ser removidos do indice via git rm --cached (Slides 30 a 34 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "Uma branch e apenas uma referencia de texto de 41 bytes contendo o hash do commit apontado, permitindo criacao e chaveamento instantaneos (Slides 45 e 46 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": False,
                        "justificativa": "O HEAD referencia a branch ou commit local ativo. Ao apontar diretamente para um commit (via git switch --detach <commit>), o Git entra no estado de Detached HEAD localmente (Slides 54 a 56 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "Na ausencia de bifurcacao divergente no historico, o Git apenas avanca o ponteiro da branch destino linearmente ate a ponta da branch mesclada (Slides 58 a 60 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O Git unifica alteracoes em arquivos distintos ou regioes distintas do mesmo arquivo de modo automatico via three-way merge, gerando conflito apenas em colisoes na mesma linha (Slides 70 e 71 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "Os delimitadores visuais marcam as duas versoes conflitantes. A resolucao manual requer correcao do texto, remocao dos marcadores e adicao ao index via git add (Slides 76 a 82 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "O rebase gera novos commits reaplicados no topo da base, gerando novos hashes e garantindo grafo linear em contraposicao ao historico topologico do merge (Slides 112 a 118 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": False,
                        "justificativa": "A regra de ouro proibe rebase em branches publicas: alterar hashes de commits ja baixados por outros colaboradores gera graves problemas de divergencia historica (Slides 116 e 118 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        "texto": "O comando git reset HEAD~1 --soft desloca o ponteiro da branch corrente de volta para o commit pai imediato, mantendo intactas as alteracoes nos arquivos do projeto e conservando-as preparadas na Staging Area para um novo commit.",
                        "correto": True,
                        "justificativa": "O modo --soft retrocede a ponta da branch sem tocar no indice nem na arvore de trabalho, deixando tudo em staging pronto para commit (Slide 133 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": True,
                        "justificativa": "O reflog rastreia toda mudanca de ponteiro local e retem os hashes de commits aparentemente perdidos, permitindo recupera-los com facilidade (Slides 136 a 140 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "O stash armazena modificacoes em andamento em uma pilha local, limpando o diretorio de trabalho para alternancia rapida de branches (Slides 146 a 148 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "A elevacao de MAJOR sinaliza quebras de compatibilidade retroativa e mudancas na assinatura publica do software (Slides 22 e 23 de smartnotes.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "O circunflexo permite atualizacoes de MINOR e PATCH na versao especificada, impedindo a subida para o proximo MAJOR (Slide 24 de smartnotes.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "Incrementos MINOR acrescentam funcionalidades retrocompativeis e exigem a reinicializacao do digito PATCH para zero (Slides 22 e 23 de smartnotes.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O til e mais conservador e restrito que o circunflexo; ele permite exclusivamente atualizacoes de PATCH dentro do mesmo MINOR (Slide 25 de smartnotes.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "O operador ~ trava a versao no nivel minor 5.2, aceitando somente incrementos no digito patch 5.2.x (Slide 25 de smartnotes.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "Configuracoes sensiveis residem em .env excluido do Git, enquanto .env.example serve como gabarito publico de variaveis para a equipe (Slides 32 a 37 de smartnotes.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "O cleanEnv valida tipagem e presenca de variaveis antes que o servidor suba, lancando excecao caso as regras sejam violadas (Slides 38 a 44 de smartnotes.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": False,
                        "justificativa": "Os papeis sao opostos: o ESLint e um Linter de analise estatica e deteccao de bugs/sintaxe; o Prettier e estritamente um Formatador de codigo visual (Slides 45 a 48 de smartnotes.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": True,
                        "justificativa": "As severidades oficiais no ESLint sao off, warn e error, permitindo dosar o rigor da analise por regra (Slides 55 e 56 de smartnotes.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "O .prettierrc padroniza as regras estilisticas e sua extensao no VS Code formata o codigo automaticamente ao salvar (Slides 60 e 61 de smartnotes.pdf)."
                    }
                ]
            }
        ]
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "O Git vincula permanentemente nome e email a cada commit para assegurar a rastreabilidade e responsabilidade dos autores (Slide 16 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "O diretorio .git e a base interna do repositorio Git onde reside toda a estrutura do versionamento (Slide 13 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        "texto": "Mensagens de commit devem ser concisas e estruturadas segundo convencao reconhecida, sendo considerado boa pratica em projetos de software registrar a finalidade da mudanca (ex.: prefixos convencionais como feat, fix, chore, docs).",
                        "correto": True,
                        "justificativa": "A adocao de mensagens descritivas e padronizadas facilita a navegacao no git log e a geracao de changelogs automaticos (Slides 26 a 29 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O comando git add . respeita estritamente os filtros definidos no .gitignore, indexando somente arquivos rastreaveis nao ignorados (Slides 23 e 30 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "O git status exibe com exatidao o estado das tres areas e arquivos nao monitorados pelo controle de versao (Slides 21, 23 e 36 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "Por padrao, git diff compara o diretorio de trabalho com o indice; para comparar o indice com o ultimo commit usa-se --staged (Slide 42 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "A flag --oneline condensa a exibicao para proporcionar uma visualizacao rapida do historico recente (Slide 41 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "O --graph desenha graficamente a convergencia e divergencia de branches e commits de merge (Slides 41 e 67 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "git diff --staged apenas visualiza as alteracoes indexadas no staging em comparacao com o HEAD; nao altera nem cria commits (Slide 42 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "Linhas com '#' no .gitignore sao comentarios explicativos que documentam os motivos de exclusao de pastas e arquivos (Slide 31 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "O clone copia o repositorio integral e estabelece origin como apelido padrao do endereco remoto (Slides 89 e 90 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": False,
                        "justificativa": "O git fetch apenas baixa dados para o repositorio local atualizando remote-tracking branches (como origin/main); ele nao altera os arquivos do working directory nem a branch local corrente (Slide 104 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "O git pull sincroniza os metadados remotos (fetch) e imediatamente mescla as alteracoes na branch local ativa (merge) (Slide 105 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": True,
                        "justificativa": "A flag -u configura a associacao upstream permanente para aquela branch (Slide 96 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": False,
                        "justificativa": "Sendo distribuido, todas as operacoes de commit, criacao de branches, consulta de log e reset sao puramente locais e offline (Slides 7 e 8 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        "valor": 1,
                        "texto": "O manifesto Twelve-Factor App prescreve a estrita separacao entre codigo-fonte e dados de configuracao, preconizando que parametros dependentes de ambiente devam ser injetados exclusivamente via variaveis de ambiente.",
                        "correto": True,
                        "justificativa": "Guardar configuracoes em variaveis de ambiente evita recompilacao e vazamento de chaves entre ambientes de desenvolvimento, homologacao e producao (Slide 32 de smartnotes.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "O metodo dotenv.config() analisa o arquivo .env e injeta as chaves em process.env para acesso programatico (Slides 34 a 36 de smartnotes.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": False,
                        "justificativa": "Arquivos .env contem senhas, segredos e chaves que nunca devem ser expostos em repositorios versionados, devendo constar impreterivelmente no .gitignore (Slide 37 de smartnotes.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": True,
                        "justificativa": "O .env.example informa a lista de chaves obrigatorias para que cada membro configure seu proprio .env local (Slide 37 de smartnotes.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "O operador de fallback '||' define um valor alternativo seguro caso a propriedade nao esteja presente em process.env (Slides 35 e 36 de smartnotes.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "A listagem comparativa de linguagens define Ruff/Pylint para analise estatica e Black/Ruff Formatter para diagramacao visual automatica (Slides 46 e 48 de smartnotes.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "Ambos os ecossistemas padronizam a formatacao nativamente atraves de gofmt e rustfmt (Slide 48 de smartnotes.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "Assim como o .gitignore, o .prettierignore poupa diretorios de saida gerados ou bibliotecas de reformatacoes desnecessarias (Slides 60 e 61 de smartnotes.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O pacote typescript-eslint permite ao ESLint analisar codigo TypeScript de forma completa, integrando regras recomendadas no eslint.config.mjs (Slides 52 e 58 de smartnotes.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "Os scripts encapsulam a chamada aos utilitarios e uniformizam sua execucao em ambientes de desenvolvimento e pipelines de automacao (Slide 62 de smartnotes.pdf)."
                    }
                ]
            }
        ]
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "O restore restaura o arquivo de trabalho com base no index, descartando edicoes locais nao salvas (Slide 120 e 121 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        "texto": "O comando git reset HEAD <arquivo> retira o arquivo indicado da Staging Area (desindexacao), preservando integralmente o conteudo modificado no Working Directory.",
                        "correto": True,
                        "justificativa": "A operacao retira o arquivo do estado staged para modified sem perder o trabalho editado pelo desenvolvedor (Slide 122 a 124 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "O comportamento padrao do reset e o --mixed, que desfaz a preparacao no index mantendo os arquivos no disco para revisao (Slide 134 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O reset --hard e uma operacao destrutiva que descarta sumariamente tanto a staging area quanto as edicoes no working directory, sem gerar novo commit (Slide 135 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "O --amend retifica o commit mais recente combinando alteracoes pendentes no index com o snapshot imediatamente anterior (Slides 143 a 145 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        "valor": 1,
                        "texto": "No estado de Detached HEAD, qualquer novo commit gerado nao pertence a nenhuma branch formal, ficando vulneravel a ser descartado pelo garbage collector do Git caso o usuario mude de branch sem criar uma referencia nominal.",
                        "correto": True,
                        "justificativa": "Sem uma branch nominal apontando para ele, o commit em detached HEAD torna-se orfao quando o HEAD se desloca (Slide 56 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "O comando git merge --abort limpa os marcadores de conflito e restabelece a branch local ao momento anterior a solicitacao de integracao (Slide 83 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": False,
                        "justificativa": "Os marcadores geram graves erros sintaticos na linguagem de programacao e impedem a compilacao/execucao do codigo ate serem removidos manualmente (Slides 76 e 77 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        "texto": "A expressao HEAD~2 referencia o commit correspondente ao 'avo' do commit atualmente ativo.",
                        "correto": True,
                        "justificativa": "A notacao de til com numero (HEAD~n) navega retroativamente na linhagem de ancestrais primarios (Slide 131 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "Diferente de git stash apply (que mantem na pilha), o pop aplica o stash e o desempilha imediatamente (Slide 148 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "O merge preserva o contexto de ramificacao e nao distorce a linha do tempo colaborativa (Slide 116 de 1_git.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "O rebase local lineariza a branch do desenvolvedor, tornando a posterior integracao na base limpa e direta (Slides 112 a 115 de 1_git.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": False,
                        "justificativa": "O rebase calcula novos hashes SHA-1 para cada commit reaplicado, destruindo a compatibilidade com colaboradores que tenham os hashes anteriores (Slides 117 e 118 de 1_git.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O git log apenas percorre commits alcancaveis na arvore atual. Commits orfaos so podem ser localizados via git reflog (Slides 136 a 139 de 1_git.pdf)."
                    },
                    {
                        "valor": 16,
                        "texto": "Em uma operacao de merge de tres vias (three-way merge), o Git utiliza tres pontos estruturais: os dois commits de topo das branches que estao sendo mescladas e o commit ancestral comum mais recente entre elas.",
                        "correto": True,
                        "justificativa": "O algoritmo de 3 vias baseia sua reconciliacao na analise diferencial entre o ancestral comum e as duas pontas divergentes (Slides 61 e 62 de 1_git.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "A semantica do versionamento divide as modificacoes entre quebras de contrato, adicoes funcionais e correcoes de bugs (Slide 22 de smartnotes.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "PATCH destina-se exclusivamente a correcoes de bugs estaveis e retrocompativeis (Slides 22 e 23 de smartnotes.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "Sem prefixos de intervalo de versao, a dependencia fica fixada (pinned) de maneira deterministica no numero informado (Slides 24 e 25 de smartnotes.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O circunflexo bloqueia categoricamente versoes com MAJOR diferente, impedindo que breaking changes sejam instaladas involuntariamente (Slide 24 de smartnotes.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "O til confina o npm update estritamente a correcoes de falhas na mesma versao minor (Slide 25 de smartnotes.pdf)."
                    }
                ]
            },
            {
                ...
                "proposicoes": [
                    {
                        ...
                        "correto": True,
                        "justificativa": "O envalid aborta a execucao imediatamente no bootstrap caso os requisitos do esquema de variaveis nao sejam cumpridos (Slides 38 a 44 de smartnotes.pdf)."
                    },
                    {
                        "valor": 2,
                        ...
                        "correto": True,
                        "justificativa": "Os validadores embutidos asseguram tipos corretos como portas validas e strings obrigatorias ou com valores padrao (Slide 40 e 41 de smartnotes.pdf)."
                    },
                    {
                        "valor": 4,
                        ...
                        "correto": True,
                        "justificativa": "O arquivo modular eslint.config.mjs carrega as recomendacoes de typescript-eslint para aplicar analise estatica ao TypeScript (Slides 52 a 58 de smartnotes.pdf)."
                    },
                    {
                        "valor": 8,
                        ...
                        "correto": False,
                        "justificativa": "O modificador 'off' desativa inteiramente a regra, fazendo com que o ESLint a ignore sem disparar avisos ou erros (Slides 55 e 56 de smartnotes.pdf)."
                    },
                    {
                        "valor": 16,
                        ...
                        "correto": True,
                        "justificativa": "A integracao no editor proporciona feedback imediato ao desenvolvedor e formatacao automatica ao salvar arquivos (Slides 51 e 61 de smartnotes.pdf)."
                    }
                ]
            }
        ]
